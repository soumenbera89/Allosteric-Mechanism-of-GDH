...
data=data.frame(individual=paste(c("ARG94","LYS114","PRO167","ASP168","MET169",
                                   "ARG211","THR215","GLN250","GLY251","PHE252",
                                 "GLY253","ASN254","VAL255","GLY274","GLU275",
                                 "SER276","LYS295","ALA325","ALA326","SER327",
                                 "GLN330","GLY347","ALA348","ASN349","ASN374","GLY377")
                                 ,c(0.04,-0.35,-0.02,-0.03,1.69,-0.46,0.02,-0.14,0.13,-0.04,
                                    0.47,-0.20,0.43,0.01,0.06,0.53,0.09,-0.02,0.45,0.30,-0.31,
                                    -0.01,0.53,-0.15,0.07,0.03)
                                 ,sep=" : "),group=c( rep('A', 5), 
                                                                              rep('B', 2), 
                                                                              rep('C', 6),
                                                      rep('D',3),rep('E',1),rep('F',7),
                                                      rep('H',2)),
                value=c(20,60,20,30,50,20,80,50,90,80,90,40,90,30,40,50,20,70,100,30,40,70,
                        90,30,90,30))
...
p
ggsave(file = "3jd3-nadh-cat.png", dpi = 300, width = 5.5, height = 5.5, units = "in")
#dev.off()
