...
ax.plot(resid4,RMSD1,color='orange',linewidth=0.75,label='Closed without NADH')
ax.plot(resid3,RMSD2,color='cornflowerblue',linewidth=0.75,label='Open without NADH')
...
fig.tight_layout()    
fig.savefig('Compair_RMSD-1-2.png', format='png', dpi=600)
