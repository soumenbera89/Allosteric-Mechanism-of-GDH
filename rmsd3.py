# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 12:17:09 2019
...
ax.plot(resid4,RMSD4,color='orange',linewidth=0.75,label='Closed with GTP & NADH')
ax.plot(resid3,RMSD1,color='navajowhite',linewidth=0.75,label='closed without GTP')
...
plt.text(resid[5], 15, r'$\alpha 1$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[33], 15, r'$\alpha 2$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[96], 15, r'$\alpha 3$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[135], 15, r'$\alpha 4$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[165], 15, r'$\alpha 5$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[207], 15, r'$\alpha 6$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[220], 15, r'$\alpha 7$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[246], 15, r'$\alpha 8$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[278], 15, r'$\alpha 9$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[347], 15, r'$\alpha 10$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[365], 15, r'$\alpha 11$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[390], 15, r'$\alpha 12$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[402], 15, r'$\alpha 13$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[427], 15, r'$\alpha 14$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[445], 15, r'$\alpha 15$', fontsize=9, alpha=0.75,rotation=90)
plt.text(resid[475], 15, r'$\alpha 16$', fontsize=9, alpha=0.75,rotation=90)
###.........................................
...
fig.tight_layout()    
fig.savefig('Compair_RMSD-1-4.png', format='png', dpi=600)
